...
By the end of the Google Summer of Code's time period, I aim to:

\begin{itemize}
\item Add two new activities in GCompris (Qt version), in the experience section (\textit{"Pilot a Submarine"} and \textit{"Sea race (Single Player)"}).
\end{itemize}

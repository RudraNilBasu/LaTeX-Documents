...
The core simulation of electricity is done and the circuits are working properly. But to make sure it is easier for the children to understand, we have to illustrate how each of the components work in a circuit via properly designed levels and instructions. For this project, I propose:
...
\item \textbf{August 6 - August 15: \textit{Implement levels with difficulty}}
